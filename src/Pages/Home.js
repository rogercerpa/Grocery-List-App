...
const Home = (props) => {
  ...
  return (
    <div className="w-full flex flex-col items-center px-4 sm:px-6 lg:px-8">
      ...
      {!user && (
        <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-6 sm:leading-8 text-gray-600 text-center">
      ...
      {user && (
        <div className="w-full flex flex-col items-center mt-4 sm:mt-6">
          <h2 className="text-base sm:text-lg leading-6 sm:leading-8 text-gray-600 text-center">
